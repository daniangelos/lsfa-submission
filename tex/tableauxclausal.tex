...
A clausal tableau calculus for a logic $L$, denoted by \calculus{L}, is a finite set of
...
Given a \calculus{L}, a \emph{tableau proof}, or just \emph{tableau}, for a set
...
from a parent by the application of one of the rules in \calculus{L}. A
